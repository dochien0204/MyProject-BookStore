...
public interface BookService {
  Map<?, ?> findAllBooks(Integer pageNo, Integer pageSize, String sortBy);
  ...
  Map<String, Object> findBookByCatalogId(Integer catalogId, Integer pageNo, Integer pageSize, String sortBy);
